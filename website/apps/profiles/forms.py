...
class SignUpOwnerForm(UserCreationForm):
    ...
    owner_key = forms.CharField( max_length=32, required=False, help_text='Enter an existing key to join an existing business. Leave blank to start a new business page.') #, validators=[valid_owner_key] )
